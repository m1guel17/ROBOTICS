...
%%
% 2. (1.0) Un sistema Fnoa ha sido girado 90º alrededor del eje X y posteriormente trasladado por el vector pxyz(8, -4, 12). Calcule las coordenadas Rx, Ry y Rz, del vector R con coordenadas Rnoa(-3, 4, -11). Use las matrices de transformación.
...
%% 
% 3. (1.5) Partiendo de que se está trabajando en el plano XY (z=0) y utilizando la información disponible en la siguiente figura determine: 
% a. (0.5) La Matriz de transformación oMa 
% b. (0.5) La Matriz de transformación aMb 
% c. (0.5) Las coordenadas del punto oP=[1, 2, 0, 1]T con respecto a los marcos {a} y {b}, es decir aP y bP, respectivamente
clc; clear all; close all;
M0 = eye(4,4)
% M0 = [1     0     0     2;...
%       0     1     0     3;...
...
a_p = inv(o_M_b)*P
%%
% 4. (2.0) Un robot está descrito por los siguientes parámetros de Denavit-Hartenberg. (Nota: Todas las unidades están en metros o radianes
% a. (1.0) Teniendo en cuenta el algoritmo de Denavit-Hartenberg. Dibuje el robot y en cada una de las articulaciones los respectivos marcos.
clc; clear all; close all
clear imports
import ETS3.*
...
trplot(eye(4))
Robot.teach
% b. (1.0) A partir de la Matriz de transformación 0M4: obtenga expresiones matemáticas que permitan, para cualquier valor de q1, q2, q3 o q4, calcular las componentes “ax”, “ay” y “az” del vector unitario “a” del marco ubicado en la punta del robot.
clc; clear all; close all
